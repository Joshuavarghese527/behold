...
class PrayersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prayer" do
    assert_difference('Prayer.count') do
      post prayers_url, params: { prayer: { attachment: @prayer.attachment, content: @prayer.content, user_id: @prayer.user_id } }
    end
  ...
  test "should update prayer" do
    patch prayer_url(@prayer), params: { prayer: { attachment: @prayer.attachment, content: @prayer.content, user_id: @prayer.user_id } }
